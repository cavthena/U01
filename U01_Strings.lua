...
local Hall5 = 'Hall_5.sfd'
local Hall10 = 'Hall_10.sfd'
local Hall15 = 'Hall_15.sfd'
local UEFBank = 'UEFBank'
...
--Cinematic Dialogue
Cinema1 = {
    {text = '[Hall]: Good morning, Lieutenant. We have a serious situation in the "Matar" system. Our latest report indicated that Cybran forces have launched a raid and Commanders were holding the line. However, we recently lost communication with them. We need to assess the situation and restore communications as soon as possible!', 
    vid = Hall15, bank = UEFBank, cue = 'Cinema1', faction = 'UEF'},
}
...
Cinema2 = {
    ...
    vid = Hall10, bank = UEFBank, cue = 'Cinema2', faction = 'UEF'},
}
...
Cinema3 = {
    ...
    vid = Hall15, bank = UEFBank, cue = 'Cinema3', faction = 'UEF'},
}
...
Cinema4 = {
    ...
    vid = Hall10, bank = UEFBank, cue = 'Cinema4', faction = 'UEF'},
}

Cinema5 = {
    {text = '[Hall]: The lives of good UEF Commanders are relying on you! Good luck, Lieutenant!', 
    vid = Hall5, bank = UEFBank, cue = 'Cinema5', faction = 'UEF'},
}