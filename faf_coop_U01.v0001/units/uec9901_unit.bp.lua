UnitBlueprint {
    ...
    Description = 'UEF Quantum Communication Array',
    Display = {
        DamageEffects = {
            {
                Bone = 0,
        ...
        Mesh = {
            ...
            LODs = {
                ...
                {
                    AlbedoName = 'uec1902_lod1_albedo.dds',
                    LODCutoff = 500,
                    ShaderName = 'Unit',
                    SpecularName = 'uec1902_lod1_specteam.dds',
                },
            },
        },
        PlaceholderMeshName = 'UEC1902',
    ...
    Interface = {
        HelpText = 'UEF Quantum Communication Array',
    },
    LifeBarHeight = 0.075,
    LifeBarOffset = 1.15,
    LifeBarSize = 2.5,
