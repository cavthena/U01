...
function Ob2bPrep()
    ...
    if not NoComs then 
        ScenarioFramework.Dialogue(OpStrings.Main2a_2, Ob2b_Easy, true, nil) 
    else
        Ob2b_Easy()
    end
end
...
function Ob2b_Easy()
    ...
    ScenarioFramework.CreateTimerTrigger(function()
        ...
        ScenarioInfo.Ob2b:AddResultCallback(function()
            ...
            if not NoComs then 
                ScenarioFramework.Dialogue(OpStrings.Main2b_1, Ob3_Easy, true, nil) 
            else
                Ob3_Easy()
            end
        end)
...
function Ob3Continue()
    ...
    ScenarioInfo.Ob3:AddResultCallback(function()
        ...
        if not NoComs then 
            ScenarioFramework.Dialogue(OpStrings.Main3_3, Ob4_Easy, true, nil) 
        else
            Ob4_Easy()
        end
    end)
